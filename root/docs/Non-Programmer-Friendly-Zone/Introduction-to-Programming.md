...
If you would like to learn more about the terms used here, please reference the [glossary](https://github.com/UNL-Lunabotics/lunabotics-documentation/wiki/Glossary)
...
Now that you have a basic understanding of programming, you can really go anywhere in the Non Programmer Friendly Zone. Specific questions that people have asked programming to explain will be listed in here, though for next steps I recommend going to [Introduction to ROS2](https://github.com/UNL-Lunabotics/lunabotics-documentation/wiki/_Non%E2%80%90Programmer-Friendly-Zone)

If you are on a mission to become a programming nerd, you will also need to know what VSCode is and how to set it up with everything you'll want, which you can find at [How to Use VSCode](https://github.com/UNL-Lunabotics/lunabotics-documentation/wiki/Introduction-to-VSCode)
