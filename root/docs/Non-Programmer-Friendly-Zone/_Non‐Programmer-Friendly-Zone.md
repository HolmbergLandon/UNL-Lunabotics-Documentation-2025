...
Before anything else, I recommend that you go straight to [Introduction to Programming](https://github.com/UNL-Lunabotics/lunabotics-documentation/wiki/Introduction-to-Programming) if you have minimal or no exposure to programming, OR if you want to find links for resources on learning how to program